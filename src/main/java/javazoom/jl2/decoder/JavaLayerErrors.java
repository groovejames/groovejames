...
{
	/**
	 * The first bitstream error code. See the {@link javazoom.jl2.decoder.DecoderErrors DecoderErrors}
	 * interface for other bitstream error codes.
	 */
	static public final int BITSTREAM_ERROR = 0x100;

	/**
	 * The first decoder error code. See the {@link javazoom.jl2.decoder.DecoderErrors DecoderErrors}
