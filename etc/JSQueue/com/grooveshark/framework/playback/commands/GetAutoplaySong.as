package com.grooveshark.framework.playback.commands
{
    ...
    public class GetAutoplaySong extends QueueCommand
    {
        ...
        public function GetAutoplaySong(param1:IDualService, param2:Queue)
        {
            super(param1, param2);
        ...
        override public function execute() : void
        {
            ...
            if (!queue.autoplayEnabled || queue.hasNextSong || queue.pendingAdds != 0)
            {
        ...
        private function onFail(param1:String, param2:Boolean = true) : void
        {
            ...
            {
                Debug.getInstance().print("[GetAutoplaySong] Failed: " + param1 + " Will re-attempt.");
            ...
            {
                Debug.getInstance().print("[GetAutoplaySong] Failed: " + param1 + " Giving up.");
                switch(param1)
                {
